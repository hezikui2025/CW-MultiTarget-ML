...
bayes_search_spaces = {
    ...
    'model__min_samples_leaf': Integer(7, 15),  
...
save_data(best_estimator, 'output/models/multi_output_dt_model.joblib')
print(f"\n模型已保存到：output/models/multi_output_dt_model.joblib")
...
save_data(evaluation_results, 'output/models/dt_multioutput_evaluation.joblib')
